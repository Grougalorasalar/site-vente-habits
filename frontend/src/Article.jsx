    ...
    function addBasket() {
        ...
        fetch(apiUrl + "/" + id)
            ...
            .then((data) => {
                ...
                props.setBasket(props.nbItemsInBasket())
                props.setTotalPrice(props.calcTotalPrice())
            })
    }
    ...
    return (
        <div className='grid grid-cols-2 grid-rows-4 max-w-5xl mx-auto gap-16'>
            ...
            <div className='flex flex-col justify-center items-center gap-4'>
                <button className='btn btn-neutral rounded-full w-72' onClick={(e) => addBasket()}>Ajouter au panier</button>
