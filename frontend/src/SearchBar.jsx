    ...
    <form className="w-full max-w-lg">
      <div className="relative text-gray-600 focus-within:text-gray-400">
        ...
        <label className="relative text-gray-400 focus-within:text-gray-600 block">
          ...
          <input placeholder="Rechercher des articles.." className="form-input border py-3 px-4 bg-white placeholder-gray-400 text-gray-500 appearance-none w-full block pl-14 focus:outline-none" onChange={handleSearchChange} />
        </label>
